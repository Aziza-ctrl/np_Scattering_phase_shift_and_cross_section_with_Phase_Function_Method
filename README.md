...
Fortran program code for neutron-proton (np) scattering phase shift and total cross-section is presented using the Phase Function Method for many two-term Potentials. 
