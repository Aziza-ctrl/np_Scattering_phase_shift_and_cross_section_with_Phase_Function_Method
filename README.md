# Neutron Proton Scattering Phase shift Simulation
...
For more information about the implementation of the Phase Function and Monte Carlo methods in nuclear scattering, see (O.S.K.S. Sastri et al., 2021).
 ...
 ## **How to use the code?**
 ### 1) Install Visual Studio or a similar IDE for running Fortran Code.
 ### 2) Make sure that the directory is correct and has all the documents provided. 
 ### 3) In the code, I implement Gnuplot to plot all functions; if you use another method, comment out the last 14 lines of code from Principal.f90

<img src="https://github.com/user-attachments/assets/76ee03cd-7b92-4ed6-95ee-5b57f7181434" width="500" />

<img src="https://github.com/user-attachments/assets/24f047f7-88fb-4b9d-ab4b-8c862f010190" width="500" />
